...
for reward_type in ['sparse', 'dense']:
    ...
    register(
        id='BaxterGolf{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:BaxterGolfEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    ...
    register(
        id='BaxterKitting{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:BaxterKittingEnv',
        kwargs=kwargs,
        max_episode_steps=100,
    )
